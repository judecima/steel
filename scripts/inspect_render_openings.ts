...
function inspectOpenings() {
    ...
    scene.objects.forEach(obj => {
        ...
        // Find which opening this belongs to. 
        // In the DTO, framing pieces only know their panelId, not their openingId. 
        // But since we have 1 opening per panel in our fixture, we can map it by panelId for the diagnostic.
