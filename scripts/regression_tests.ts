...
async function runTests() {
  ...
  const result1 = panelizeHouse(house1);
  ...
  try {
      ...
      const result3 = panelizeHouse(house3);
  ...
  const result5 = panelizeHouse(house5);
